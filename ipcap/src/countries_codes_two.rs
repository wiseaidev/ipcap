...
///
/// ```
/// use ipcap::countries_codes_two::COUNTRY_CODES_TWO;
///
/// // Accessing country code for the first country
/// let first_country_code = COUNTRY_CODES_TWO[1];
/// assert_eq!(first_country_code, "AP");
///
/// // Accessing country code for Lebanon
/// let usa_country_code = COUNTRY_CODES_TWO[124];
/// assert_eq!(usa_country_code, "LB");
/// ```
pub static COUNTRY_CODES_TWO: [&str; 255] = [
